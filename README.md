...
ui_dict = uilib.ui.value.UI_Dict(
  {}, 
  add_func=lambda: uilib.ui.value.UI_HardDict(
    {
...
ui_button = uilib.ui.layout.UI_Button("Print value", lambda: print(repr(ui_root.get_value()))) #ウィジットの設定値を出力するボタン。
ui_root = uilib.ui.layout.UI_Layout(
  [
    [ui_dict],
    [(ui_button, 1, 1, uilib.enum_.Direction.E)]
  ],
  ui_dict
)
